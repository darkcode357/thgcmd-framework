...
STYLE_NEVER = 'Never'
"""
Constant for ``thgcmd.ansi.allow_style`` to indicate ANSI style sequences should
be removed from all output.
"""
STYLE_TERMINAL = 'Terminal'
"""
Constant for ``thgcmd.ansi.allow_style`` to indicate ANSI style sequences
...
"""When using outside of a thgcmd app, set this variable to one of:
...
"""Partial function supplying arguments to :meth:`thgcmd.ansi.style()` which colors text to signify success"""

style_warning = functools.partial(style, fg=fg.bright_yellow)
"""Partial function supplying arguments to :meth:`thgcmd.ansi.style()` which colors text to signify a warning"""

style_error = functools.partial(style, fg=fg.bright_red)
"""Partial function supplying arguments to :meth:`thgcmd.ansi.style()` which colors text to signify an error"""
